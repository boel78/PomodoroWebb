    ...
    public partial class localSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Achievme__DE508E2E6000B13C", x => x.aid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("UserAchievements_pk", x => new { x.UID, x.AchievementID });
                    table.ForeignKey(
                        name: "UserAchievements_Achievements_aid_fk",
                        column: x => x.AchievementID,
                        principalTable: "Achievements",
                        principalColumn: "aid");
                    table.ForeignKey(
                        name: "UserAchievements_AspNetUsers_Id_fk",
                        column: x => x.UID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("UserSessions_pk", x => new { x.UID, x.SessionID });
                    table.ForeignKey(
                        name: "UserSessions_AspNetUsers_Id_fk",
                        column: x => x.UID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
